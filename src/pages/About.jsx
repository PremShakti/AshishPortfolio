...
<Box>
    <Text as={'h2'} fontSize={{base:20,lg:30}} fontWeight={'bold'} textAlign={{base:"center" ,lg:"left"}} >Expert AC Mechanical - Your One-Stop Solution for All Air Conditioning Needs in Bhubaneswar, Cuttack, and Kendrapara</Text>
    <UnorderedList fontSize={'sm'}mt={5}>
        ...
        <ListItem>Contact us today for all your air conditioning needs in Bhubaneswar, Cuttack, and Kendrapara. </ListItem>
    </UnorderedList>
</Box>
